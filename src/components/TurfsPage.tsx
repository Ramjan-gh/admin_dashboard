...
export function TurfsPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // REMOVED the leading slashes here to prevent double-slash issues
    ...
    if (isEdit) body.p_id = selectedTurf.id;

    try {
      // Added a explicit slash between rpc and methodName
  ...
  return (
    <div className="p-4 lg:p-6 space-y-6 bg-gray-50 min-h-screen">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 font-sans">Fields</h1>
                  ...
                  {(dragProvided, dragSnapshot) => (
                    ...
                    >
                      ...
                      <div className="p-5 space-y-4">
                        {/* Stats Info Grid - EXACT STRUCTURE */}
