...
//..........................................................................................................................................................................................
//for testing purposes, we will remove the admin check and allow any authenticated user to log in. The code above is commented out and replaced with a simplified version below.
//..........................................................................................................................................................................................
  ...
  useEffect(() => {
    ...
    const handleAuthCallback = async () => {
      ...
      try {
        ...
        if (accessToken) {
          // TESTING MODE: admin check removed — any authenticated user is allowed in.
          const userInfoRes = await fetch(`${SUPABASE_URL}/auth/v1/user`, {
            headers: {
              "Authorization": `Bearer ${accessToken}`,
              "apikey": import.meta.env.VITE_SUPABASE_ANON_KEY,
